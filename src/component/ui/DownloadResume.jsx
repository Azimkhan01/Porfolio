...
function DownloadResume() {
  ...
  return (
    <div onBlur={()=>{setIsClick(!isClick)}}  className={`${isClick ? 'w-40 h-50' : ' w-20 h-20' } flex flex-col  justify-evenly  items-center transition-all ease-out duration-200  z-5 fixed bottom-5 rounded-3xl border-1 border-white right-5  bg-[#000000df]`}>
