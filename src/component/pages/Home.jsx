  ...
  const pn = [
    {
      ...
      description:
        "High-quality herbal extracts, fruit extracts, and natural powders for nutraceutical, cosmetic & food industries - 100% pure & tested.",
      link: "https://botanixnatural.com",
    },
    {
      projectName: "Gym Management",
      description:
        "Membership management that allow to handle member send mail delete arrangement and so on.",
      link: "https://gym-management-docs.vercel.app",
    },
    {
      projectName: "HomeQuest",
      description:
        "Real Estate website for listing property and agent appointment aloting them our property for faster progress.",
    ...
    <>
      ...
      <motion.div className="h-screen flex flex-col justify-center items-center ">
        <h1
          ...
          className=" text-2xl md:text-[60px]  font-semibold "
        >
          Hi,I'm Azimuddeen Khan
        </h1>
        <h1 className="text-xl md:text-[30px] font-light">
          I am Mern Stack Developer
        </h1>
        <h1 className="py-2 flex gap-1 justify-center items-center">
          Love to build
          <motion.span
            ref={wordRef}
            className="bg-gradient-to-l   from-green-500 to-green-300 py-1 px-2 rounded shadow text-white font-semibold block transition-all ease-in-out duration-150"
          >
            {love}
          </motion.span>
        </h1>
      ...
      <div>
        <div className="text-black text-3xl font-bold p-4 flex justify-center flex-col md:flex-row  sticky top-0   h-screen bg-[#EFEFEF] ">
          ...
          <div className=" w-full md:w-1/2 flex flex-col justify-evenly">
            ...
            <div>
              <Link
                className="text-sm text-green-500 rounded-4xl border-2  border-transparent hover:border-green-500  transition-all ease-linear duration-150 p-2"
                to={"/contact"}
              >
                Know more {"->"}
              </Link>
        ...
        <div
          ref={containerRef}
          className="text-white  text-3xl font-bold p-4 flex justify-center sticky top-0 h-screen bg-[#161719]"
        >
          <div className="flex flex-col mt-[5%] gap-10 md:gap-0  w-5/6">
            <div className="flex w-full h-1/5 ">
              <div className="w-1/2 flex flex-col gap-1  ">
                <h1 className="text-green-500 text-2xl md:text-4xl font-medium">
                  FEATURED PROJECTS
                </h1>
                <p className="text-gray text-lg md:text-2xl font-thin">
                  Selected Works
                </p>
              </div>
              ...
              <div className="flex w-1/2 justify-center items-center p-6">
                <Link
                  to={"/project"}
                  className="flex justify-center  items-center gap-2  font-thin text-lg hover:text-green-400 transition-all ease-linear duration-150 "
                >
                  <span className=" w-full flex justify-center items-center  font-thin text-sm md:text-lg hover:text-green-400 transition-all ease-linear duration-150 hover:underline underline-offset-6">
                    See Projects
                  </span>{" "}
                  <FaArrowRightLong />{" "}
                </Link>
        ...
        <div className="text-white text-3xl font-bold p-4 flex flex-col justify-center items-start md:items-center  sticky  top-0  h-screen bg-[#0F1012]">
          <div className=" w-full md:w-5/6 flex flex-col justify-center items-center h-2/3 md:h-2/6 ">
            ...
            <div className="w-full mt-10 flex justify-center items-center">
              <p className=" text-2xl md:text-4xl font-normal text-center">
                ...
                with a blend of logic, creativity, and innovation
              </p>
            </div>
          </div>
          <div className="w-full overflow-x-hidden  md:mt-10">
            <motion.div
              ...
              className="p-4 w-full flex flex-row  items-center flex-nowrap gap-20  md:gap-30"
            >
