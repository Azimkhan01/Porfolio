...
function Project() {
  ...
  return (
    <>
      ...
      <meta
        name="description"
        content="Explore Azimuddeen Khan’s full stack web development projects built with React, Node.js, and MongoDB. Showcasing real-world applications and modern solutions."
      />
      ...
      <div className="h-screen flex justify-center items-center">
        <h1 className=" text-[60px] md:text-[150px]  text-[#262626]">
