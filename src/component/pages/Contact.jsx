...
function Contact() {
  ...
  return (
    ...
    <meta name="description" content="Get in touch with Azimuddeen Khan for project inquiries, collaborations, or freelance opportunities in full stack web development." />
<link rel="canonical" href='/contact' />
    ...
    <div className=' bg-[#E8E2E2] h-screen sticky top-0 flex flex-col justify-center items-center gap-10 '>
        ...
        <div className=' w-3/6 md:w-1/6 bg-[#D4D4D4] rounded-full flex justify-center items-center hover:animate-pulse transition-all ease-in-out duration-200'><img lazy className='w-6/6' src='/handshake.svg' alt='handShake'/></div>
