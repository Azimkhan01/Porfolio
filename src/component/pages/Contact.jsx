    ...
    <div className=' bg-[#E8E2E2] h-screen sticky top-0 flex flex-col justify-center items-center gap-10 '>
        ...
        <div><h1 className='text-gray-600 text-4xl font-bold'>Tell me about your next project</h1></div>
          <div className='flex gap-3'>
            ...
            <a className='px-6 py-3 rounded-3xl text-white font-semibold text-lg hover:animate-pulse  bg-green-400 ' href='https://api.whatsapp.com/send?phone=917678084267&text=Hi%20wanna%20hire%20for%20freelancing'>Whatsapp</a>
          </div>
    </div>
